...
{
    public class ProductDiscountRepository_Linq:Repository<Product_Discount>, IProductDiscountRepository_Linq
    {
        public ProductDiscountRepository_Linq(MyDBContext context) : base(context)
    {
    }
